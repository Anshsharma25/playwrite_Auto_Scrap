...
'''
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
now here is the code start with frontent
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
'''
...
# '''
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# now here is the code start with cedula
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# '''

# """
# Simple runner that hardcodes cedula/password and runs the cedula automation flow.
# Run with:
#     python -m src.main
# """
...
# # src/main.py
# """
# Runner for cedula automation using direct iduruguay login.
# Run with:
#     python -m src.main
# """
...
# import time
# from playwright.sync_api import sync_playwright
# from src.cedula import login_with_cedula_direct

# # Hardcoded for local testing only
# CEDULA = "18295245"
# PASSWORD = "mmmss3031744"

# def main(headless: bool = False, keep_open: bool = True):
#     print(f"[INFO] Starting automation (headless={headless}). Hardcoded cedula={CEDULA}")
#     with sync_playwright() as pw:
#         browser = pw.chromium.launch(headless=headless)
#         context = browser.new_context()
#         page = context.new_page()
#         try:
#             final_page, final_url = login_with_cedula_direct(
#                 page,
#                 cedula=str(CEDULA),
...
#             )
#             print("[INFO] Login flow finished. Final URL:", final_url)
#         except Exception as e:
#             print("[ERROR] Automation failed:", e)
#         finally:
#             if not headless and keep_open:
#                 try:
#                     input("\nBrowser is kept open for inspection. Press Enter to close...")
#                 except KeyboardInterrupt:
#                     pass
#             try:
#                 context.close()
...
# if __name__ == "__main__":
#     # visible browser & keep open for debugging by default
#     main(headless=False, keep_open=True)
